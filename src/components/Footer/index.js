        ...
        <FooterWrap>
          <FooterLinksContainer>
            <FooterFormWrapper>
              <FooterForm action="#">
                ...
                <FormText>
                  Subscribe and get information about our upcoming events.
                </FormText>
                <FormInput
                  type="email"
                  name="email"
          ...
          <SocialMedia>
            <SocialsWrap>
              ...
              <SocialIcons>
                <SocialIconLink
                  href="//www.facebook.com/worlddragracingcircuit/"
                  target="_blank"
                  aria-label="Facebook"
                >
                  <FaFacebook />
                ...
                <SocialIconLink
                  href="//www.instagram.com/worlddragracing/"
                  target="_blank"
                ...
                <SocialIconLink
                  href="//www.youtube.com/user/racersntuners"
                  target="_blank"
                  aria-label="Youtube"
                >
                  <FaYoutube />
